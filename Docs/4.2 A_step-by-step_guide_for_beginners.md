...
1. Download and install <a href="https://www.techsmith.com/download/snagit">Snagit</a> (2-week free trial).
2. Open a Microsoft <a href="https://app.clipchamp.com/login">Clipchamp</a> account (free of charge).
...
<img src="../Images/Captions_editing_in_Clipcham.png" alt="A dark mode view of Clipchamp video editor while editing captions" width="100%">

Source: Clipchamp Blog
