title: 4.1 Guidelines 
layout: default 
parent: 4. Making accessible videos
nav_order: 1
...
- Test your content with the target audience. It is crucial to have it checked with different,  impaired users.
